...
<?php
 ...
 <body >
  <div class="container px-4">
       ...
       <div class="col">
         <div class="p-3">
           <div class="p-3 border bg-primary text-white ">
             <h2 class="text-center">Anticipo Proveedor: <?php echo $consultaProveedor[2] ?> </h2>
           </div>
         </div>
       </div>
     </div>
    ...
    <form action="cargaDriveProveedoresPrepago.php" class="container-fluid" method="post" enctype="multipart/form-data">
<div class="container-fluid">
 ...
 <div class="container-fluid">
    ...
    <textarea name="descripcion" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingrese alguna descripción" required> 
    </textarea> 
</div>
...
<div class="container-fluid">
    ...
    <input name="valor" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Valor del cheque o Transferencia" required step="any">
