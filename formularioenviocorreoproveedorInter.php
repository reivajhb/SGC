 ...
 <body>
   ...
   <div class="mx-auto" style="width: 50%;" class="container">
     <form action="enviarcorreoProveedoresInter.php" class="container-fluid" method="post" enctype="multipart/form-data">
       <div class="container-fluid">
         ...
         <input name="descripcion" type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $consulta[8] ?>">
         ...
         <a class="collapse" type="hidden" href="<?php echo $consulta[19] ?>">
           <input name="relacionpago" type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $consulta[19] ?>"><?php echo $consulta[19] ?>
         </a>
         ...
         <table class="table table-bordered ">
           <thead>
             ...
             <tr>
               ...
               <th scope="col">Relacion de pagos</th>
           ...
           <tbody>
             ...
             <tr>
              ...
              echo $numero  ?></td>
              <td><a href="<?php echo $consulta[19] ?>"target="_blank"><img width="50" height="50" src="./img/factura.png"  /></a></td>
