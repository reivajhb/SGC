...
$to_date=!empty($_GET['to_date']) ? $_GET['to_date'] : null;
   ...
   $consultaSum = "SELECT SUM(ValorTotalApagar) as 'total' FROM tbl_anticipos  WHERE fecha BETWEEN '$from_date' AND '$to_date' AND estado = 'Pagado' || estado = 'Soporte enviado y pagado' ";
...
$consultaSum2 = "SELECT SUM(ValorTotalApagar) as 'total' FROM tbl_anticipos  WHERE fecha BETWEEN '$from_date' AND '$to_date' AND estado = 'Pendiente'";
  ...
  <div class="row gx-5">
    <div class="col">
   <div class="p-3"><h2>Consulta pagos Anticipos de Proveedores Turisticos Por fecha</h2>
   </div>
    </div>
  </div>
</div>
...
<?php 
                       include 'conexion.php'; 
                                ...
                                if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM tbl_anticipos WHERE fecha BETWEEN '$from_date' AND '$to_date' ";
