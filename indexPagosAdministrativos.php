...
<h3 class="display-6">Pagos Administrativos Panamericana de viajes</h3>
</div>
 ...
 <div class="card bg-dark text-white" style="border-radius: 1rem;">
  <div class="card-body p-5 text-center">   	
	<form action="cargarPagosAdministrativos.php" class="container-fluid" method="post" enctype="multipart/form-data" >
  <div class="container-fluid">
  <label for="exampleInputEmail1">Locacion</label>
  <input name="locacion" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nombre de Locación">
  <small id="emailHelp" class="form-text text-muted">Ingrese el nombre del hotel</small>
  </div>
  <div class="container-fluid">
  <label for="exampleInputEmail1">Valor</label>
  <input name="valor" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingrese el Valor a pagar">
