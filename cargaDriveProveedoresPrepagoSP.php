...
$editarProveedorPrepago = "UPDATE tbl_anticipos SET fecha='$fecha', identificacion='$identificacion',
                                ...
                                soportePrepago='$ruta', fecha_Soporte='$fecha_Soporte' where id_anticipo='$id_anticipo' ";
...
$consulta = "SELECT * FROM tbl_anticipos where id_anticipo='$id_anticipo' ";
...
<body  class = 'row align-item-center justify-content-center vh-100'>
  ...
  <div class='row align-items-center'>
    ...
    <div class='col'>
    <a href='formularioenviocorreoproveedorPrepago.php?id_anticipo= " . $mostrarProveedor['id_anticipo'] . "''>
