    ...
    <div class="content">
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <a class="navbar-brand" href="#">
                <img style="margin-left: 15px;" src="/facturacion/img/pnv.png" width="30" height="30" alt="Logo">
                SGC ERP
            </a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown my-2 my-lg-0">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownUser">
                            ...
                            Cerrar Sesión   <i style="width: 5px !important; height: 5px !important; margin-left: 5px !important;" class="fas fa-sign-out-alt fa-lg"></i> 
                        </a>
                            <?php
