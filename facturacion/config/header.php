...
<nav class="navbar fixed-top navbar-expand-lg  navbar-dark "style="background-color: black;">
  ...
  <a class="navbar-brand" href=""><img src="facturacion/img/pnv.png" width="50" height="50"> </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/facturacion/facturacion/project/usuarios/CerrarSesion.php">Cerrar Sesión <span class="sr-only">(current)</span></a>
      <li class="nav-item dropdown">
      <li class="nav-item active">
        <a class="nav-link" href="/facturacion/facturacion/views/indexFacturacion.php">Inicio<span class="sr-only">(current)</span></a>
      <!--<li class="nav-item dropdown">
