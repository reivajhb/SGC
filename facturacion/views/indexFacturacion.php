<?php 
include __DIR__ . "/../config/seguridad.php";
?>
...
<br>
  ...
  <body background="/facturacion/img/fondoindex.jpg">

<main class="container">
  <section class="card card-red">
    <div class="product-image">
      <img src="/facturacion/img/hotel.jpg" style="width:100%; height: 100%;  margin-top: 20px; border-radius: 3px;" alt="OFF-white Red Edition" draggable="false" />
    </div>
    ...
    <div class="btn">
      <button class="buy-btn" onclick="location.href='/facturacion/facturacion/project/clienteHAA/consultaFacturasHAAPublic.php'">Consultar</button>
      <button class="fav">
  ...
  <section class="card card-blue">
    <div class="product-image">
      <img src="/facturacion/img/tiquetes.jpg" style="width:100%; height:100%;  margin-top: 20px; border-radius: 3px;" alt="OFF-white Blue Edition" draggable="false" />
    </div>
    <div class="product-info">
      <h2>Facturas</h2>
      <p>Tiquetes Aereos</p>
    ...
    <div class="btn">
      <button class="buy-btn" onclick="location.href='/facturacion/facturacion/project/facturasCorp/consultaFacturasCorpPublic.php'">Consultar</button>
      <button class="fav">
