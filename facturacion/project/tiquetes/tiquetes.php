...
// Si el usuario no es administrador, redirigir a la página de buscarProveedor
if (isset($_SESSION['id_rol']) && $_SESSION['id_rol'] != 1) {
    echo "<script>alert('Acceso denegado.'); window.location.href = 'buscarProveedor.php';</script>";
    exit();
}

$logFile = 'C:\xampp\htdocs\Facturacion\logs\log_tiquetes.txt';
?>
...
$ejecutar_fp = mysqli_query($conn, $consulta_fp);
          ...
          foreach ($resultado_combinado as $mostrarPaAdmin) {
            ...
            // Verificar si algún campo comienza con "K-F o K-R"

            $dato_kf = ""; // Inicializar la variable fuera del bucle

            for ($i = 1; $i <= 58; $i++) {
                $campo = $mostrarPaAdmin['campo' . $i];
                if (strpos($campo, 'K-F') === 0 || strpos($campo, 'K-R') === 0) {
                    $dato_kf = $campo;
  ...
  <path d='m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z'/>
      ...
      echo "
       ...
       <button type='button'class='btn btn-danger' data-toggle='modal' data-target='#exampleModalCenter<?php echo $id_tiquete; ?>'><svg
                            xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor'
                            class='bi bi-trash-fill' viewBox='0 0 16 16'>
                            <path
                                d='M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z' />
                        </svg></button>
                        <div class='modal fade' id='exampleModalCenter<?php echo $id_tiquete; ?>' tabindex='-1'
                            role='dialog' aria-labelledby='exampleModalCenterTitle' aria-hidden='true'>
                            <div class='modal-dialog modal-dialog-centered' role='document'>
                                <div class='modal-content'>
                                    <div class='modal-header'>
                                        <h5 class='modal-title' id='exampleModalLongTitle'>¿Estás seguro de que deseas
                                            eliminar este registro?</h5>
                                    ...
                                    <div class='modal-footer'>
                                        ...
                                        <a href='EliminarPagosAdministrativos.php?id_tiquete= ".$mostrarPaAdmin ['id_tiquete']."''><button type='button'
                        ...
                        echo "<td>
                            <button type='button' class='btn btn-primary' data-toggle='modal'
                                data-target='#exampleModal".$id_tiquete."'>
                                <?xml version='1.0' encoding='utf-8'?>

                                <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                                <svg height='25px' width='25px' version='1.1' id='Uploaded to svgrepo.com'
    ...
    c0.206-0.183,0.438-0.116,0.517,0.146l3.369,11.229C22.306,28.046,22.496,28.074,22.648,27.845z' />
                                        <path class='duotone_twee'
                                            d='M14.464,8.153l2.451-2.451c0.194-0.194,0.513-0.194,0.707,0l0.707,0.707
    ...
    c-0.194-0.194-0.513-0.194-0.707,0l-0.853,0.853l0.219,2.61l2.048-2.048c0.194-0.194,0.194-0.513,0-0.707L25.497,17.756z' />
                            ...
                            <!-- Modal -->
                            <div class='modal fade bd-example-modal-lg' id='exampleModal".$id_tiquete."' tabindex='-1'
...
$sql = "INSERT INTO tbl_resum_tiquetes (tipo_trato, vendedor, importe, fecha_cierre, nombre_trato, nom_agen_cli, tipo_moneda, tipo_soli_serv, canal_venta, fecha_salida, num_pasajeros, destinos, Centro_costo, localizador, fecha_emision, fecha_servicio, num_tiquete, tipo_pago, proveedor, ruta, emd, enviado, netotarifatiquete, impuestostiquete, totalimpuestostiquete)
        SELECT 
        '$tipo_trato', '$vendedor', '$importe', '$fecha_cierre', '$nombre_trato', '$nom_agen_cli', '$tipo_moneda', 
        '$tipo_soli_serv', '$canal_venta', '$fecha_salida', '$num_pasajeros', '$destinos', 
        '$Centro_costo', '$localizador', '$fecha_emision', '$fecha_servicio', '$num_tiquete', 
        '$tipo_pago', '$proveedor', '$ruta', '$emd', '$enviado', '$netotarifatiquete', 
        '$impuestostiquete', '$totalimpuestostiquete'WHERE '$fecha_cierre' = '$fecha_actual'";
...
// Procesamiento de datos de tiquetes y actualización de la base de datos
// Aquí va tu código de tiquetes.php para procesar los datos...

// Al final del procesamiento, registrar la ejecución en el archivo de log
file_put_contents($logFile, "tiquetes.php ejecutado correctamente en: " . date('Y-m-d H:i:s') . "\n", FILE_APPEND);

// Continuar con el procesamiento
echo "<script>console.log('tiquetes.php ejecutado correctamente en: " . date('Y-m-d H:i:s') . "');</script>";
?>
...
?>
    ...
    $(document).ready(function() {
        ...
        $('#modalDetalles<?php echo $id_tiquete; ?>').on('show.bs.modal', function(event) {
            ...
            var idTiquete = button.data(
            'idtiquete'); // Extraer el ID del tiquete de los datos del botón
