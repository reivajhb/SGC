...
<body>
    ...
    <div class="mx-auto" style="width: 1600px;">
        <div class="container" style="width: 1000px; ">
            <h3 class="display-4">Busqueda Clientes Para Solicitud de facturación de Hoteles, Alojamientos y
                alimentación</h3>
        </div>
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class=" text-black" style="border-radius: 0rem;">
                <div class="card-body p-5">
                    ...
                    <form action="RegistroFacturasHAA.php" class="container-fluid" method="get"
