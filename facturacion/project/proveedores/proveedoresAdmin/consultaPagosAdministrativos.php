...
<body class="bg-image">
    ...
    <?php
    include "../../../config/conexion.php";
    $consultaSum = "SELECT SUM(valor_pagado) as 'total' FROM tbl_pagos WHERE estado = 'Pagado' AND YEAR(fecha_pago) = YEAR(CURDATE()) AND  tipo_pago = 'Administrativo'";
    ...
    $consultaSum2 = "SELECT SUM(valor_pagado) as 'total' FROM tbl_pagos where estado = 'Pendiente' AND YEAR(fecha_pago) = YEAR(CURDATE()) AND  tipo_pago = 'Administrativo'";
        ...
        <div class="row justify-content-center mb-3">
            <div class="col-auto">
                <div class="bg-primary text-white text-center px-5 py-3 rounded" style="box-shadow: 0 6px 20px rgba(0,0,0,0.2); border: none;">
                    <h2 class="mb-0 fw-bold">INFORMACIÓN PAGOS ADMINISTRATIVOS</h2>
                </div>
            </div>
        </div>
    ...
    <div class="container" style="width: 100%;">
        ...
        <div class="row g-4 mb-3">
                ...
                <div class="col-auto text-start">
                    ...
                    <button class="btn btn-success">
                        <a class="text-light" href="../../../genexcel/ExcelPagosAdministrativos.php">Descargar información
        ...
        <div class="table-responsive-scroll mb-3" style="border-radius: 10px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
        ...
        <style>
            ...
            #myTable3 thead th {
                box-shadow: inset 0 1px 0 #1a3a5c, inset 0 -1px 0 #1a3a5c;
            }
        </style>
        ...
        <script>
            ...
            function cargarTabla(page) {
                ...
                xhttp.open('GET', 'tablaproveedoresadmin.php?page=' + page + '&limit=' + LIMIT + '&search=' + encodeURIComponent(search), true);
                xhttp.send();
            }
