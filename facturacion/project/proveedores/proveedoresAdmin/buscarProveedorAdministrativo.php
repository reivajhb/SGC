        ...
        <div class="card text-center" style="max-width: 520px; width: 100%;">
            ...
            <div class="card-body">
                <h5 class="card-title mb-3">
                    Ingrese el Numero de Nit del Proveedor
                </h5>

                <form action="formularioCargaDriveAdministrativos.php" method="get" class="container-fluid p-0">
                    <input
                        name="nit"
                        type="number"
                        class="form-control"
                        placeholder="Ingrese el Numero de Nit del Proveedor"
                        required
                    >
