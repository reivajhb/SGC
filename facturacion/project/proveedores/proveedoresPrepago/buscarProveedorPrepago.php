...
?>
    ...
    <?php
    // Incluir solo el menú, no toda la estructura
    ...
    <div class="container py-4 min-vh-80 d-flex align-items-center justify-content-center" style="height: 80vh;">
        <div class="card text-center" style="max-width: 520px; width: 100%;">
            <div class="card-header">
                Búsqueda Proveedor para Anticipos
            </div>
            <div class="card-body">
                <h5 class="card-title mb-3">Ingrese el Número de Nit o Cédula del Proveedor</h5>
                <form action="formularioCargaDriveProveedoresPrepago.php" method="get" class="container-fluid p-0">
                    <input name="identificacion" type="number" class="form-control" placeholder="Ingrese el Número de Nit o Cédula del Proveedor" required>
                    <div class="mt-3">
