        ...
        <div class="row justify-content-center mb-3">
            <div class="col-auto">
                <div class="bg-primary text-white text-center px-5 py-3 rounded" style="box-shadow: 0 6px 20px rgba(0,0,0,0.50); border: none;">
                    <h2 class="mb-0 fw-bold">INFORMACIÓN PAGOS ANTICIPOS CON RETENCIONES</h2>
                </div>
            </div>
        </div>
                    ...
                    if (this.readyState == 4) {
                        ...
                        if (this.status == 200) {
                            try {
                                ...
                                document.getElementById('tabla_resultados').innerHTML = '<tr><td colspan="11" class="text-center text-danger">Error al cargar los datos.</td></tr>';
                            }
                        }
                    }
                };
                xhttp.open('GET', 'tablaproveedoresprepagoRT.php?page=' + page + '&limit=' + LIMIT + '&search=' + encodeURIComponent(search), true);
                xhttp.send();
            }
