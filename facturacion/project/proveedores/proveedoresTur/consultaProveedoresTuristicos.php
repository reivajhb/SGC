...
<body class="bg-image">
    ...
    <?php
    include "../../../config/conexion.php";
    $consultaSum = "SELECT SUM(valor_pagado) as 'total' FROM tbl_pagos WHERE estado = 'Pagado' AND YEAR(fecha_pago) = YEAR(CURDATE()) AND  tipo_pago = 'Turístico'";
    ...
    $consultaSum2 = "SELECT SUM(valor_pagado) as 'total' FROM tbl_pagos where estado = 'Pendiente' AND YEAR(fecha_pago) = YEAR(CURDATE())AND  tipo_pago = 'Turístico' ";
    ...
    <div class="container px-4 mt-0">
        <div class="row justify-content-center mb-3">
            <div class="col-auto">
                <div class="bg-primary text-white text-center px-5 py-3 rounded" style="box-shadow: 0 6px 20px rgba(0,0,0,0.2);">
                    <h2 class="mb-0 fw-bold">INFORMACIÓN PAGOS TURÍSTICOS</h2>
                </div>
            </div>
        </div>
        <div class="row gx-4 mb-4">
            <div class="col">
                <div class="bg-success text-white px-4 py-3 rounded" style="box-shadow: 0 6px 20px rgba(0, 0, 0, 0.2); border: none;">
                    <h2 class="mb-0">Pagado: $<?php echo $numero ?></h2>
                </div>
            </div>
            <div class="col">
                <div class="bg-danger text-white px-4 py-3 rounded" style="box-shadow: 0 6px 20px rgba(0, 0, 0, 0.2); border: none;">
    ...
    <div class="container" style="width: 100%;">
        ...
        <div class="row g-4 mb-3" style="padding-left: 12px;">
                ...
                <div class="col-auto text-start">
                    <a class="btn btn-success text-light" href="../../../genexcel/ExcelPagosProveedores.php">
        ...
        <div class="table-responsive-scroll" style="width: 100%; overflow: hidden; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2); margin-top: 0.5rem;">
        <table class="table mb-0" id="myTable3">
                    <thead style="background-color: #1a3a5c; color: #ffffff;">
                        <tr>
                            ...
                            <th scope="col">Valor Sin retenciones</th>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a id="modal-link-eliminar" href="#"><button type="button" class="btn btn-danger">Eliminar</button></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            $(document).on('click', '.btn-eliminar', function () {
                ...
                $('#modal-link-eliminar').attr('href', 'EliminarProveedoresTuristicos.php?id_pago=' + id);
            ...
            function cargarTabla(page) {
                ...
                xhttp.open('GET', 'tablaproveedoresturisticos.php?page=' + page + '&limit=' + LIMIT + '&search=' + encodeURIComponent(search), true);
                xhttp.send();
            }
