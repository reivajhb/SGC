...
<body>
    ...
    <div class="container py-4 min-vh-80 d-flex align-items-center justify-content-center" style="height: 80vh;">
        <div class="card text-center" style="max-width: 520px; width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.5); background-color: #ffffff;">
            <div class="card-header">
                Búsqueda Proveedor Internacional
            </div>

            <div class="card-body">
                <h5 class="card-title mb-3">
                    Ingrese el Número de Nit o Cédula del Proveedor
                </h5>

                <form action="formularioCargaDriveProveedoresInter.php" method="get" class="container-fluid p-0">
