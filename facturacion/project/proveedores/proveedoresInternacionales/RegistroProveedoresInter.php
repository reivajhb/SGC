...
<head>
    ...
    <title>Registro Proveedor Internacional</title>
...
<body style="margin-top: 0 !important; padding-top: 0 !important;" id="cuerpo-registro">
    ...
    <div id="container-formulario">
        ...
        <div class="header-proveedor text-center">
            ...
            <p class="mb-0 text-white-50">Gestión de Proveedores Internacionales</p>
        </div>
        ...
        <div style="margin-top: 100px; padding-top: 0;" class="card card-proveedor">
            <div class="card-body p-4 p-md-5">
                <form action="cargaProveedorPrepago.php" method="post" enctype="multipart/form-data">
                    ...
                    <input name="tipo_proveedor" type="hidden" value="Internacional">

                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <label class="label-custom">NIT / Tax ID*</label>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input name="nombre" type="text" class="form-control input-custom"
                                placeholder="Razón Social Internacional" required>
                        </div>
                    </div>
