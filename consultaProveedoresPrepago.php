...
<?php
  include 'conexion.php'; 
   ...
   $consultaSum = "SELECT estado, SUM(valor) as 'total' FROM tbl_anticipos where estado = 'Pagado' || estado = 'Soporte enviado y pagado'";
...
<?php
   $consultaSum2 = "SELECT estado, SUM(valor) as 'total' FROM tbl_anticipos where estado = 'Pendiente'";
   ...
   ?>    <div class="container px-4">
    <div class="row gx-5 align-items-center">
        <div class="col-auto">
            <div class="p-3"><h2>Información Aticipos</h2></div>
        </div>
        <div class="col-6">
            <div class="container">
                <button class="btn btn-success">
                    <a class="text-light" href="ExcelPagosProveedoresPrepago.php">Descargar información
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    xhttp.open("GET", "tablaproveedoresprepago.php?num_registros=" + numRegistros, true);
    xhttp.send();
});
