...
$consulta = "SELECT * FROM tbl_proveedores_turtisticos ORDER BY CASE WHEN estado = 'pendiente' THEN 0 ELSE 1 END, fecha DESC LIMIT $numRegistros";
...
while ($mostrarProveedor = mysqli_fetch_array($ejecutar)) {
     $id_proveedor = $mostrarProveedor['id_proveedor'];
    echo '<tr>';
    // Aquí generas las celdas de la tabla con los datos de cada proveedor
    // Por ejemplo:
  ...
  <path d='m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z'/>
      ...
      echo "
       ...
       <button type='button'class='btn btn-danger' data-toggle='modal' data-target='#exampleModalCenter<?php echo $id_proveedor; ?>'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill'viewBox='0 0 16 16'>
  <path d='M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z'/>
</svg></button>
<div class='modal fade' id='exampleModalCenter<?php echo $id_proveedor; ?>' tabindex='-1' role='dialog' aria-labelledby='exampleModalCenterTitle' aria-hidden='true'>
  ...
  <tbody>
    <tr>
      ...
      <td>".$mostrarProveedor ['id_proveedor'] ."</td>
      ...
      <div class='modal-footer'>
        ...
        <a href='EliminarProveedoresTuristicos.php?id_proveedor= ".$mostrarProveedor ['id_proveedor']."''><button type='button' class='btn btn-danger'>Eliminar</button></a>
      </div>
    </div>
  </div>
</div>
...
echo "<td><a href='formularioenviocorreoproveedor.php?id_proveedor= ".$mostrarProveedor  ['id_proveedor']."''><button type='button' class='btn btn-primary'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-envelope-plus-fill' viewBox='0 0 16 16'>
  ...
  <path d='M16 12.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Zm-3.5-2a.5.5 0 0 0-.5.5v1h-1a.5.5 0 0 0 0 1h1v1a.5.5 0 0 0 1 0v-1h1a.5.5 0 0 0 0-1h-1v-1a.5.5 0 0 0-.5-.5Z'/>
    ...
    echo '<td>' . $mostrarProveedor['nit'] . '</td>';
    echo '<td>' . $mostrarProveedor['proveedor'] . '</td>';
     $valorApagar1 = $mostrarProveedor ['cop'];
     $numero1 = number_format($valorApagar1, 0, ",", ".");
    echo '<td>' .'$'. $numero1 . '</td>';
    echo '<td>' . $mostrarProveedor['novedad'] . '</td>';
    echo '<td>' . $mostrarProveedor['fecha'] . '</td>';
    echo '<td><a href="' . $mostrarProveedor['archivo'] . '" target="_blank"><img width="50" height="50" src="./img/factura.png" alt="Soporte"></a></td>';
    echo '<td>' . $mostrarProveedor['estado'] . '</td>';
    echo '<td><a href="' . $mostrarProveedor['soporteProveedor'] . '" target="_blank"><img width="50" height="50" src="./img/factura.png" alt="Soporte"></a></td>';
