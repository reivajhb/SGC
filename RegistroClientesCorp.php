...
include "sidebar.php"
 ?>
  ...
  <head>
    ...
    <title>Registro de nuevos proveedores tiristicos!</title>

  </head>
 <body >
  <br>
  <div class="mx-auto" style="width: 800px;" >
<h3 class="display-4">Registro de nuevos clientes corporativos</h3>
</div>
 ...
 <div>
    ...
    <form action="cargaClienteCorp.php" class="container-fluid" method="post" enctype="multipart/form-data">
<div class="container-fluid">
  ...
  <div class="container-fluid">
    ...
    <input name="nom_clien_corp" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingrese el nombre del Proveedor" required>
