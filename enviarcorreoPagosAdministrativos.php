...
try {
	...
	$soporteAdmin = $_POST['soporteAdmin'];
...
'<br>',
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Relación de facturas</th>
...
'</body>
    ...
    $mail->Username   = 'AKIAYS2NV44SYRA6SBNL';                     //SMTP username                     //SMTP username
    $mail->Password   = 'BKApQHD4iU6w4isV/sRLOt3ivcsOkXutARfYNHHe3Zow';                               //SMTP password
    $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('contabilidad8@panamericanaviajes.com', 'Pagos Administrativos Panamericana de viajes');
    ...
    $mail->Body    = implode("<tr><th scope='col'></th></tr>", $datos  );
