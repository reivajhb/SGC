...
<br>
  ...
  include 'conexion.php'; 
   ...
   $consultaSum = "SELECT SUM(ValorTotalApagar) as 'total' FROM tbl_anticipos where estado = 'Pagado' || estado = 'Soporte enviado y pagado'";
   ...
   ?>
    ...
    <div class="row gx-5 align-items-center">
        <div class="col-auto">
            <div class="p-3"><h2>Información Anticipos Proveedores</h2></div>
        </div>
        <div class="col-6">
            <div class="container">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    xhttp.open("GET", "tablaproveedoresprepagoRT.php?num_registros=" + numRegistros, true);
    xhttp.send();
});
