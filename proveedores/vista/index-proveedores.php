                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="login-card">
                        <div class="text-center mb-4">
                            ...
                            <h3 class="fw-bold mb-1">Acceso Proveedores</h3>
                            <p class="text-muted mb-0">Ingrese su usuario y contraseña</p>
                        </div>

                        <form action="../controlador/validarProveedores.php" method="POST">
                            ...
                            <button class="btn btn-custom btn-block mt-4" type="submit">
                                Ingresar
                            </button>
                        </form>
