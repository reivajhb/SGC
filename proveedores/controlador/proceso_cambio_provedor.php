    ...
    if (password_verify($contraseña_actual, $contraseña_hash)) {
        ...
        if ($nueva_contraseña === $confirmar_contraseña) {
            ...
            echo '<script>
                    ...
                    window.location = "../vista/miCuentaProveedor.php"; // Redireccionar a la página de perfil u otra página
                  </script>';
        } else {
            echo '<script>
                    alert("Las contraseñas nuevas no coinciden");
                    window.location = "../vista/cambiarPassProveedor.php"; // Redireccionar de vuelta al formulario
                  </script>';
        }
    } else {
        echo '<script>
