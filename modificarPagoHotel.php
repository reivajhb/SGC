 ...
 <div>
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class=" text-dark" style="border-radius: 0rem;">
          <div class="card-body p-5 ">   	
	<form action="cargaDriveHotelSP.php" class="container-fluid" method="post" enctype="multipart/form-data" >
  ...
  <div class="container-fluid">
    ...
    <input name="Hotel" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $consulta[1]?>">
