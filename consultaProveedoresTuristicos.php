  ...
  include 'conexion.php'; 
   ...
   ?>
    ...
    <div class="row gx-5 align-items-center">
        <div class="col-auto">
            <div class="p-3"><h2>Información Pagos Proveedores turisticos</h2></div>
        </div>
        <div class="col-6">
            <div class="container">
                <button class="btn btn-success">
                    <a class="text-light" href="ExcelPagosProveedores.php">Descargar información
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    xhttp.open("GET", "tablaproveedoresturisticos.php?num_registros=" + numRegistros, true);
    xhttp.send();
});
